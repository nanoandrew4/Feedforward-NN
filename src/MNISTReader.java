...
/**
 * Code completely copied from https://github.com/jeffgriffith/mnist-reader
 * All credit for this class goes to jeffgriffith
 *
 * Used to read in the MNIST data set freely available on the internet.
 */
